...
| -------------------------------- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| App shell and routing            | `src/app`, `middleware.js`                                                          | Composes route trees, redirects, layouts, metadata entry points, and route protection; does not own business rules                             |
