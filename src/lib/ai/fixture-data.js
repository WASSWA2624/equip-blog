export const microscopeAcceptanceFixture = Object.freeze({
  ...
  researchInput: Object.freeze({
    aliases: ["Laboratory microscope", "Optical microscope", "Compound microscope"],
    components: Object.freeze([
      {
        description:
          "Provides the first stage of magnification and supports comfortable binocular or monocular viewing.",
      ...
      {
        description:
          "The stage positions the slide and allows precise X-Y movement for systematic specimen scanning.",
    ...
    faults: Object.freeze([
      {
        ...
        severity: "medium",
        sourceReferenceIds: ["src_fixture_manual_focus", "src_fixture_manual_cleaning"],
        symptoms: "The specimen appears hazy, lacks edge definition, or will not reach a crisp image at expected magnification.",
      ...
      {
        cause: "Slide placement is unstable, stage clips are loose, or the specimen is not centered before magnification changes.",
        severity: "low",
    ...
    manuals: Object.freeze([
      ...
      },
      {
        ...
        language: "English",
        lastCheckedAt: "2026-04-03T08:00:00.000Z",
        notes: "Preventive maintenance checklist for illumination and inspection tasks.",
        sourceReferenceIds: ["src_fixture_manual_illumination"],
    ...
    maintenanceTasks: Object.freeze([
      ...
      {
        description:
          "Verify lamp output, condenser travel, focus smoothness, and stage travel against the acceptance checklist.",
        frequency: "Monthly",
        label: "Check functional controls",
        sourceReferenceIds: ["src_fixture_manual_illumination", "src_fixture_manual_focus"],
      },
      {
        description:
        ...
        models: Object.freeze([
          {
            ...
            sourceReferenceIds: ["src_fixture_northfield_model_page", "src_fixture_northfield_manual"],
            summary:
              "An entry-level laboratory microscope model commonly used for brightfield instruction and routine bench work.",
          },
        ]),
        name: "Northfield Optics",
        primaryDomain: "northfield-optics.example",
        sourceReferenceIds: ["src_fixture_northfield_brand_page", "src_fixture_distributor_reference"],
      },
      {
        aliases: ["Ridgeview"],
        models: Object.freeze([
          {
            ...
            sourceReferenceIds: ["src_fixture_ridgeview_model_page", "src_fixture_ridgeview_manual"],
            summary:
              "A higher-specification microscope with enhanced illumination control and imaging accessories.",
          },
        ]),
        name: "Ridgeview Scientific",
        primaryDomain: "ridgeview-scientific.example",
        sourceReferenceIds: ["src_fixture_ridgeview_brand_page", "src_fixture_distributor_reference"],
      },
      {
        aliases: ["Aperture"],
        models: Object.freeze([
          {
            ...
            sourceReferenceIds: ["src_fixture_aperture_model_page", "src_fixture_aperture_manual"],
            summary:
              "A compact teaching-laboratory microscope with simplified controls and a smaller bench footprint.",
          },
        ]),
        name: "Aperture Scientific",
        primaryDomain: "aperture-scientific.example",
        sourceReferenceIds: ["src_fixture_aperture_brand_page", "src_fixture_education_reference"],
      },
    ]),
    mediaCandidates: Object.freeze([
      {
        alt: "Bench microscope prepared for laboratory inspection.",
        attributionText: "Image metadata for laboratory microscope setup.",
        caption:
        ...
        sourceUrl: "https://upload.wikimedia.org/wikipedia/commons/c/cd/Microscope_Machine.jpg",
        storageDriver: "external-source",
        usageNotes: "Used as sample microscopy imagery for editorial previews.",
        width: 1400,
      },
      {
        alt: "Close view of microscope optics and focus controls.",
        attributionText: "Image metadata for optics and focus illustration.",
        caption:
        ...
        sourceDomain: "fixtures.example",
        sourceReferenceIds: ["src_fixture_image_reference"],
        sourceUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d0/Laboratory_Microscope.jpg",
        storageDriver: "external-source",
        usageNotes: "Used as an inline microscopy illustration.",
        width: 1400,
      },
    ]),
    ...
    sourceReferences: Object.freeze([
      {
        ...
        title: "Microscope fundamentals overview",
      ...
      },
      {
        ...
        sourceType: "TRUSTED_BIOMEDICAL_REFERENCE",
        title: "Optical magnification overview",
      ...
      },
      {
        ...
        title: "Microscope components teaching note",
      ...
      },
      {
        ...
        sourceType: "REPUTABLE_EDUCATIONAL_INSTITUTION",
        title: "Microscope teaching applications note",
      ...
      },
      {
        ...
        title: "Approved distributor listing for microscopes",
      ...
      },
      {
        ...
        sourceDomain: "fixtures.example",
        sourceType: "OFFICIAL_MANUAL",
        title: "Microscope focusing and handling note",
      ...
      },
      {
        ...
        sourceDomain: "fixtures.example",
        sourceType: "OFFICIAL_MANUAL",
        title: "Microscope illumination maintenance note",
      ...
      },
      {
        ...
        sourceDomain: "fixtures.example",
        sourceType: "OFFICIAL_MANUAL",
        title: "Microscope stage handling note",
      ...
      },
      {
        ...
        title: "Microscope imagery source",
...
export function getFixtureByNormalizedEquipmentName(normalizedEquipmentName) {
  if (normalizedEquipmentName === "microscope") {
